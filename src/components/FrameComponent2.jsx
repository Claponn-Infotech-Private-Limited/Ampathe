...
const FrameComponent2 = ({ className = "" }) => {
  ...
  return (
    <div
      className={`self-stretch flex flex-col items-center justify-center py-5 px-5 box-border max-w-full text-center text-13xl text-heading font-lato ${className} mq450:mt-[60px]`}
    >
      <div className="w-full max-w-[1118px] flex flex-col items-center justify-start gap-8 md:gap-6 lg:gap-8">
        <div className="text-[24px] md:text-[36px] lg:text-[48px] font-semibold">
          FAQ’s
        </div>
