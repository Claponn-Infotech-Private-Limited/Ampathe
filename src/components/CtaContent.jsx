...
const CtaContent = ({ className = "" }) => {
  return (
    <div
      className={`self-stretch h-[243px] relative bg-lightblue-100 max-w-full text-center text-13xl text-heading font-lato  ${className}`}
    >
      ...
      <div className="absolute top-[90px] left-[0px] w-full flex flex-col items-start justify-start gap-6 max-w-full text-5xl">
        ...
        <div className="self-stretch flex flex-row items-start justify-center py-0 px-5 box-border max-w-full text-left text-base text-body ">
