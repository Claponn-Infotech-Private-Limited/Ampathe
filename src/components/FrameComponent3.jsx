    ...
    >
      ...
      <div className="self-stretch flex flex-row items-start justify-center py-0 px-0 box-border gap-6 max-w-full text-left text-5xl mq1425:flex-wrap">
        <TestimonialCards
          ...
          moreAuthorImages="/ellipse-11@2x.png"
          priyaS="Priya S"
          className="flex-1"
        />
        <TestimonialCards
          ...
          moreAuthorImages="/ellipse-11-1@2x.png"
          priyaS="Priya, Delhi"
          propMinWidth="81px"
          className="flex-1"
        />
        <div className="flex-1 shadow-[0px_8px_10px_rgba(0,_0,_0,_0.1)] rounded-lg bg-white flex flex-col items-start justify-between p-4 box-border min-w-[308px] h-[292px] max-w-full mq1425:h-auto">
          ...
          <div className="self-stretch flex flex-col items-start justify-start gap-4 text-xl text-body">
            <div className="self-stretch relative mq450:text-base">
              The daily check for mental health suggest and the app provides
              clear guidance based on my score and the community feature is
