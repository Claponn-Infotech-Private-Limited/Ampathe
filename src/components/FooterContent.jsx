...
const FooterContent = ({ className = "" }) => {
  return (
    ...
    >
      ...
      <div className="self-stretch flex flex-row items-start justify-center max-w-full text-base font-lato">
        <div className="w-[596px] relative inline-block shrink-0 max-w-full">
