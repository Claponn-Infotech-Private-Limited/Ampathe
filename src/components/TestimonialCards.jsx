...
const TestimonialCards = ({
  ...
  return (
    <div
      className={`flex-1 shadow-[0px_8px_10px_rgba(0,_0,_0,_0.1)] rounded-lg bg-white flex flex-col items-start justify-center py-7 px-4 box-border gap-4 min-w-[308px] max-w-full text-left text-5xl text-heading font-lato ${className}`}
